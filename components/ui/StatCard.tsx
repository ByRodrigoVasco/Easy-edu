...
export default function StatCard({ value, description }: StatCardProps) {
  return (
    <div className="flex h-full min-h-56 flex-col rounded-xl border border-rule bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg md:p-8">

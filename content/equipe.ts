...
export const members = [
  {
    ...
    // PENDENTE: referência à Wee Find Pro / Wee Conecta sinalizada no briefing v2 (seção 5.1)
    // como não verificável publicamente. Mantida como está por decisão de Rodrigo até a equipe
    // decidir se guarda, remove ou substitui por comprovação.
    background:
